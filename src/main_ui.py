...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line_mongo_cluster = QLineEdit(self.groupBox_3)
        self.line_mongo_cluster.setObjectName(u"line_mongo_cluster")
        self.line_mongo_cluster.setEnabled(False)

        self.horizontalLayout_4.addWidget(self.line_mongo_cluster)
        ...
        self.line_new_user = QLineEdit(self.groupBox_2)
        self.line_new_user.setObjectName(u"line_new_user")

        self.horizontalLayout_2.addWidget(self.line_new_user)

        self.line_new_password = QLineEdit(self.groupBox_2)
        self.line_new_password.setObjectName(u"line_new_password")
        self.line_new_password.setEchoMode(QLineEdit.EchoMode.Normal)

        self.horizontalLayout_2.addWidget(self.line_new_password)
        ...
        QWidget.setTabOrder(self.line_mongo_url, self.line_mongo_username)
        QWidget.setTabOrder(self.line_mongo_username, self.line_mongo_password)
        QWidget.setTabOrder(self.line_mongo_password, self.line_mongo_cluster)
        QWidget.setTabOrder(self.line_mongo_cluster, self.radio_on_mongo_cloud)
        QWidget.setTabOrder(self.radio_on_mongo_cloud, self.line_mongo_database)
        QWidget.setTabOrder(self.line_mongo_database, self.line_mongo_collection)
        QWidget.setTabOrder(self.line_mongo_collection, self.button_db_connect)
        ...
        QWidget.setTabOrder(self.button_user_connect, self.line_new_user)
        QWidget.setTabOrder(self.line_new_user, self.line_new_password)
        QWidget.setTabOrder(self.line_new_password, self.button_add)
        QWidget.setTabOrder(self.button_add, self.line_user_search)
        QWidget.setTabOrder(self.line_user_search, self.button_search)
        QWidget.setTabOrder(self.button_search, self.button_delete)
...
#if QT_CONFIG(statustip)
        self.line_mongo_cluster.setStatusTip(QCoreApplication.translate("MainWindow", u"Used only for MongoDB Cloud", None))
#endif // QT_CONFIG(statustip)
        self.line_mongo_cluster.setPlaceholderText(QCoreApplication.translate("MainWindow", u"MongoDB Cluster", None))
#if QT_CONFIG(statustip)
...
#if QT_CONFIG(statustip)
        self.line_new_user.setStatusTip(QCoreApplication.translate("MainWindow", u"Register a new user for hello world", None))
#endif // QT_CONFIG(statustip)
        self.line_new_user.setPlaceholderText(QCoreApplication.translate("MainWindow", u"User email", None))
#if QT_CONFIG(statustip)
        self.line_new_password.setStatusTip(QCoreApplication.translate("MainWindow", u"Register a password for the new user for hello world", None))
#endif // QT_CONFIG(statustip)
        self.line_new_password.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Password", None))
